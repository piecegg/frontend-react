            ...
            <div className=" grid text-[#312E2A]   font-Montserrat">
                ...
                <div className="row flex  px-5 ">
                    <div className='w-full  border-b items-center flex border-[#D3C5B0]   text-[16px] font-[300]'>
                        <div className={isOthers ? 'delay-150 border-b-4 py-2 border-[#312E2A] mr-5 font-[600]' : 'py-2 mr-5'} onClick={() => setIsOthers(true)}>By Others </div>
                        <div className={!isOthers ? 'delay-150 border-b-4 py-2 border-[#312E2A] mr-5 font-[600]' : 'py-2'} onClick={() => setIsOthers(false)}>By me</div>
                        ...
                        <ul className="    ">
                            <li
                                ...
                                <div className=' leading-none row flex w-full font-Lora font-[400] text-[16px] '>
                                    Whoever has one of these on Jan 1st will get an airdrop of some New Years art.
