        ...
        {isTabletOrMobile &&
            <div><div className="mt-5 ml-4">
                ...
                <div onClick={() =>{
                     ...
                     window.open(process.env.REACT_APP_TWITTER_AUTH_LOGIN_LINK+"?page=login", "_self")
                     }} className=' flex cursor-pointer -mb-5 transition-all ease-out shadow-md mt-6 mx-auto gap-3 border-2 rounded-md border-slate-900 w-96 pl-24  py-4'>
