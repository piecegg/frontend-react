                ...
                <div>
                  ...
                  >
                    <button
                      ...
                      className=" hover:scale-105 transition-all ease-out font-opensans w-fit mx-auto rounded-md bg-opacity-70 px-20 py-3 hover:bg-opacity-100 text-stone-200 bg-fadeochre"
                    >
                      Collect ($1)
                    </button>
                  </motion.div>
