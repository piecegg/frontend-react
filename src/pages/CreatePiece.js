            ...
            <div className=" grid text-[#312E2A]   font-Montserrat">
                ...
                <div className="row px-5 ">
                    ...
                    <div className=" w-full my-4   flex justify-center ">
                        ...
                        <button className={textCode ? ' w-full p-3  bg-opacity-90 text-stone-200 bg-fadeochre' : 'w-full p-3  bg-opacity-40 text-stone-200 bg-fadeochre'}>Text verification code</button>
